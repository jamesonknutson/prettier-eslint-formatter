declare module "vscode" {
    type ExtensionCommands = "prettier-eslint-formatter.forceFormatDocument" | "prettier-eslint-formatter.openOutput" | "prettier-eslint-formatter.restartDaemons"
    ...
    export namespace workspace {
        export function getConfiguration(
            section: 'prettier-eslint-formatter',
...
interface Configuration {
    "prettier-eslint-formatter.enableDebugLogs"?: boolean;
    "prettier-eslint-formatter.isEnabled"?:       boolean;
    "prettier-eslint-formatter.useDaemons"?:      boolean;
    [property: string]: any;
}
export {}
